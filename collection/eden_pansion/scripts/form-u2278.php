...
{
	$to = 'genes.ima@gmail.com';
	$subject = 'Eden Pansion Contact Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U2309"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Cell Phone:</b></td><td>' . htmlentities($_REQUEST["custom_U2366"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Company:</b></td><td>' . htmlentities($_REQUEST["custom_U2376"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U2371"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
