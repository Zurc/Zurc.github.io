...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Contact Us:</b></td><td>' . htmlentities($_REQUEST["custom_U767"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Messae:</b></td><td>' . htmlentities($_REQUEST["custom_U773"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
